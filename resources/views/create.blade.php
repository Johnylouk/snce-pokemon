...
@section('content')
    <div name="container" class="flex justify-center">
        ...
        <a href="{{ url('/') }}" class="bg-blue-400 hover:bg-blue-900 text-white font-bold mr-8 p-1 rounded">Home</a>
               <form class="" action="create" method="POST" >
                    {{ csrf_field() }}
                    <div class="input-group">
                        <input type="text"  name="name" placeholder="Create Team">
                        <span class="input-group-btn">
                    <button type="submit" class="bg-blue-400 hover:bg-blue-900 text-white font-bold py-1 px-1 rounded">Create</button>
                        </span>
        ...
        @if (isset($team_id))
                <form action="create" method="POST" >
                    ...
                    <button type="submit" class="bg-blue-400 hover:bg-blue-900 text-white font-bold py-1 px-1 rounded">Gotta Catch 'Em All</button>
                </form>
            </span>
            @endif
            ...
            @if (isset($data))
            <span class="m-8 place-self-center text-white border-4 border-gray-500">
                <div class="p-8 text-white">
                    <h1 class="text-xl">Pokemon Captured!</h1>
                </div>
