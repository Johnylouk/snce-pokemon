...
<div>
    ...
    <span class="">
        ...
        <form class="mt-8 ml-2" action="edit" method="POST" >
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn">
                        <button type="submit" class="bg-blue-400 hover:bg-blue-900 text-white font-bold py-1 px-1 rounded">Change Name</button>
                </span>
        ...
        <form class="ml-2 mt-8" action="/team/create" method="POST" >
                    {{ csrf_field() }}
                    <input type="hidden"  name="team_id" value="{{$team_id}}">
                    <button type="submit" class="bg-blue-400 hover:bg-blue-900 text-white font-bold rounded">Gotta Catch 'Em All</button>
        </form>
        @if(\App\Models\Pokemon::where('team_id', $team_id)->first() == NULL)
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn">
                <button type="submit" class="bg-blue-400 hover:bg-blue-900 text-white font-bold py-1 px-1 rounded">Delete Team</button>
                </span>
            </div>
        </form>
        @endif
        ...
        <div class="inline-grid grid-cols-1 mt-16">
           ...
           <img src="{{$pokemon->img}}">
            <form action="edit" method="POST">
                ...
                <button type="submit" class="bg-blue-400 hover:bg-blue-900 text-white font-bold rounded">Set Free</button>
            </form>
            </div>
        @endforeach
    </span>
